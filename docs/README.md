...
5. Delete the entire [docs folder](/docs) along with all the files inside it. These files are only meant for teachers, and are not meant to be included in any assignment you make for your students.
